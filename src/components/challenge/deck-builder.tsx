  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div className="text-center">
        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">デッキを編成</h2>
      ...
      <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-950/50">
        <p className="mb-3 text-sm font-medium text-gray-700 dark:text-gray-300">選択中のデッキ</p>
