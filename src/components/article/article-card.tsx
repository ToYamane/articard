...
export function ArticleCard({ article, isFavorite, onFavoriteToggle }: ArticleCardProps) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {onFavoriteToggle && (
        <FavoriteButton isFavorite={!!isFavorite} onToggle={onFavoriteToggle} size="md" />
      )}
    </div>
  );
}
